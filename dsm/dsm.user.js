...
function nextGet(n){
    var cur = ''+n,
        ...
        all = '1234567890', nn = ['000000000','111111111','222222222','333333333','444444444','555555555','666666666','777777777','888888888','999999999'],
        gets = [], i;
    n = parseInt(n);
    gets.push(n);
    ...
    for (i = 0; i < nn.length; i++) {
        ...
        gets.push(parseInt((first2 + nn[i]).substring(0,cur.length)));
    }
    gets.sort(function(a,b){return a-b;});
